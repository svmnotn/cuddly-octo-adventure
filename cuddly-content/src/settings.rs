...
fn build_settings_sound(tabs: &gtk::Notebook) {
    ...
    numeric_input!(cont,
                ...
                "The default volume of the background music.", 100f64, 0f64);
    ...
    numeric_input!(cont,
                ...
                "The default volume of the sound played when an answer is correct.", 100f64, 0f64);
    ...
    numeric_input!(cont,
                ...
                "The default volume of the sound played when an answer is wrong.", 100f64, 0f64);
...
fn build_settings_time(tabs: &gtk::Notebook) {
    ...
    numeric_input!(cont,
                ...
                "Pre Answer Delay: ",
                "The amount of seconds to wait for an answer to be given.", 3600f64, 0f64);
    ...
    ARCHIVE.write().unwrap().settings.time.post_ans_delay,
                "Post Answer Delay: ",
                "The amount of sconds to wait after an answer has been given.", 3600f64, 0f64);
    ...
    ARCHIVE.write().unwrap().settings.time.score_delay,
                "Score Delay: ",
                "The amount of sconds to wait while displaying the scores.", 3600f64, 0f64);
    ...
    ARCHIVE.write().unwrap().settings.time.game_over_delay,
                "Game Over Delay: ",
                "The amount of time to wait while displaying the game over screen.", 3600f64, 0f64);
